...
If you would be interested in attending a talk on this topic, please get in touch with me at <a href="mailto:{{ site.email | uri_escape }}" aria-label="email address {{ site.email }}">{{ site.email }}</a>. I will open this up to the wider community if there is enough interest. I am also available for bespoke 1-2-1 physiotherapy consultations to discuss your individual needs and create a personalised exercise plan.
